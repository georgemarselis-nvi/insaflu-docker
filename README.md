...
to run compute nodes on a separate physical machine instead, or
[`SWARM_VS_KUBERNETES.md`](SWARM_VS_KUBERNETES.md) to distribute the whole stack across a cluster.
