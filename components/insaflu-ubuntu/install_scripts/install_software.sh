...
echo "Install prokka"
cd /software && git clone --branch v1.15.6 https://github.com/tseemann/prokka.git && mv /tmp_install/software/prokka/tbl2asn /software/prokka/bin/ && chmod +x /software/prokka/bin/tbl2asn #&& /software/prokka/bin/prokka --setupdb
